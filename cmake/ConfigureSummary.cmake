...
function( NEST_PRINT_CONFIG_SUMMARY )
  ...
  if ( HAVE_RECORDINGBACKEND_ARBOR  )
    message( "Build recording backend Arbor   : Yes" )
  else ()
    message( "Build recording backend Arbor   : No" )
  endif ()

  if ( HAVE_SIONLIB )
    message( "Build recording backend SIONlib : Yes (SIONlib ${SION_EXECUTABLE})")
    message( "    SIONlib includes            : ${SIONLIB_INCLUDE}" )
    message( "    SIONlib libraries           : ${SIONLIB_LIBRARIES}" )
    message( "" )
  else ()
    message( "Build recording backend SIONlib : No")
  endif ()
